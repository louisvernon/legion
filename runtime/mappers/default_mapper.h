...
namespace Legion {
  namespace Mapping {
    ...
    protected:
      ...
      unsigned next_local_io, next_local_py, next_local_cpu, next_local_gpu, next_local_procset;
      Processor next_global_io,next_global_py,next_global_cpu,next_global_gpu,next_global_procset;
      Machine::ProcessorQuery *global_io_query, *global_py_query, *global_cpu_query,
